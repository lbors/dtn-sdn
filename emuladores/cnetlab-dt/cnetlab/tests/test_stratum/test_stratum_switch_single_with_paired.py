...
class Topo(Dataplane):
    ...
    def create_links(self):
        ...
        self.add_link('leaf1e', 'spine1', mtu=9000)
        self.add_link('leaf1e', 'spine2', mtu=9000)
        self.add_link('leaf2e', 'spine1', mtu=9000)
        self.add_link('leaf2e', 'spine2', mtu=9000)

        # Leaf-Spine lado direito
        self.add_link('leaf1d', 'spine1', mtu=9000)
        self.add_link('leaf1d', 'spine2', mtu=9000)
        self.add_link('leaf2d', 'spine1', mtu=9000)
        self.add_link('leaf2d', 'spine2', mtu=9000)
