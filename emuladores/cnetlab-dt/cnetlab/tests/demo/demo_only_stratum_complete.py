...
class Topology(Dataplane):
    ...
    def nodes(self):
        # Data Center West
        self.add_node("spine_w1", Stratum("spine_w1", pipeconf=PIPECONF_BMV2))
        self.add_node("spine_w2", Stratum("spine_w2", pipeconf=PIPECONF_BMV2))
        self.add_node("leaf_w1", Stratum("leaf_w1", pipeconf=PIPECONF_FABRIC))
        self.add_node("leaf_w2", Stratum("leaf_w2", pipeconf=PIPECONF_FABRIC))
        self.add_node("dtn1", SimpleHost("dtn1", ctl=False))
        self.add_node("dtn2", SimpleHost("dtn2", ctl=False))

        # Data Center East
        self.add_node("spine_e1", Stratum("spine_e1", pipeconf=PIPECONF_BMV2))
        self.add_node("spine_e2", Stratum("spine_e2", pipeconf=PIPECONF_BMV2))
        self.add_node("leaf_e1", Stratum("leaf_e1", pipeconf=PIPECONF_FABRIC))
        self.add_node("leaf_e2", Stratum("leaf_e2", pipeconf=PIPECONF_FABRIC))
    ...
    def set_links(self):
        # Set West-East Link
        self.add_link("spine_w1", "spine_e1")
        self.add_link("spine_w2", "spine_e2")
