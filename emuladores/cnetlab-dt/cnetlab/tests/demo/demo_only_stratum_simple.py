...
# curl -sSL --user karaf:karaf --noproxy localhost -X POST -H 'Content-Type:application/json' http://172.17.0.2:8181/onos/v1/network/configuration/ -d@demo_only_stratum_simple.json
class Topology(Dataplane):
    ...
    def send_config_onos(self):
        ...
        # stratum_interface("ctl1", "leaf_w1", "dtn2", "3", "10.0.1.254", "24", 10)
        stratum_interface("ctl1", "leaf_e1", "dtn3", "2", "10.0.3.254", "24", 20)
        # stratum_interface("ctl1", "leaf_e1", "dtn4", "3", "10.0.3.254", "24", 20)
