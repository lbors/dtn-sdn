...
class Stratum(Devices):
    def __init__(self, id, name, address, **params):
        ...
        self._node_sid = params.get('node_sid', None)
        self._router_mac = params.get('router_mac', None)
    ...
    @property
    def node_sid(self):
        return self._node_sid

    @node_sid.setter
    def node_sid(self, value):
        self._node_sid = value
    ...
    def network_config(device):
        ...
        return name, pipeconf, address, edgeRouter, mgmAddress, nodeSid, routerMac
